...
K:"ytp-mdx-manual-pairing-popup-dialog",U:{role:"dialog"},S:[{D:"div",K:"ytp-mdx-manual-pairing-popup-dialog-inner-content",S:[{D:"div",K:"ytp-mdx-manual-pairing-popup-title",oa:"Pronto dejar\u00e1 de ser posible establecer una conexi\u00f3n web con una TV mediante un c\u00f3digo"},{D:"div",K:"ytp-mdx-manual-pairing-popup-buttons",S:[{D:"button",Ca:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],oa:"M\u00e1s informaci\u00f3n"},{D:"button",Ca:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],
oa:"Aceptar"}]}]}]});this.i=new g.xK(this,250);this.learnMoreButton=this.Ba("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.Ba("ytp-mdx-manual-pairing-popup-ok");g.G(this,this.i);this.N(this.learnMoreButton,"click",this.l);this.N(this.okButton,"click",this.u)},G7=function(){g.V.call(this,{D:"div",
K:"ytp-mdx-popup-dialog",U:{role:"dialog"},S:[{D:"div",K:"ytp-mdx-popup-dialog-inner-content",S:[{D:"div",K:"ytp-mdx-popup-title",oa:"No has iniciado sesi\u00f3n"},{D:"div",K:"ytp-mdx-popup-description",oa:"Los v\u00eddeos que veas podr\u00edan aparecer en el historial de reproducciones de la TV e influir en las recomendaciones. Puedes evitarlo si cancelas e inicias sesi\u00f3n en YouTube desde tu ordenador."},{D:"div",K:"ytp-mdx-privacy-popup-buttons",S:[{D:"button",Ca:["ytp-button","ytp-mdx-privacy-popup-cancel"],
oa:"Cancelar"},{D:"button",Ca:["ytp-button","ytp-mdx-privacy-popup-confirm"],oa:"Confirmar"}]}]}]});this.i=new g.xK(this,250);this.cancelButton=this.Ba("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Ba("ytp-mdx-privacy-popup-confirm");g.G(this,this.i);this.N(this.cancelButton,"click",this.l);this.N(this.confirmButton,"click",this.u)},H7=function(a){g.V.call(this,{D:"div",
...
b=g.T(b,128)?g.xH("No se ha podido reproducir el v\u00eddeo en $RECEIVER_NAME",c):b.wc()||g.T(b,4)?g.xH("El v\u00eddeo se est\u00e1 reproduciendo en $RECEIVER_NAME",c):g.xH("Conectado a $RECEIVER_NAME",c);a.Ra("statustext",b);a.i.show()}else a.i.hide()},I7=function(a,b){g.UO.call(this,"Reproducir en",0,a,b);
...
I7.prototype.ni=function(a){return"cast-selector-receiver"===a?"Reparto...":this.Lm[a].name};
